...
SELECT DISTINCT res.id, res.name, l.city, l.country, s.name, pm.name, * FROM restaurants AS res, status AS s, location AS l, 
...
SELECT u.uid, u.name, reviews_user.review_count FROM users AS u, 
...
--  Restaurant Owner gives his own review.
